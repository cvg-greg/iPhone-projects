...
(function (G) {
  ...
  const render = () => {
    ...
    gbBody.innerHTML = `
      ...
      <p>Easiest of all: run <code>tools/convert_apple_loops.sh</code> (included) once in Terminal — it scans
      <b>all</b> of those locations automatically, converts everything to WAV, and collects it in
      <code>~/Desktop/Music GenEngine/GarageBand Sounds</code>, ready for “Import folder…” in any browser.</p>`;
