...
(function (G) {
  ...
  const render = () => {
    ...
    gbBody.innerHTML = `
      <p>On your Mac, GarageBand's loops and one-shots live here — open Finder, press <b>⌘⇧G</b> and paste:</p>
      <ul>
        ...
        <li><code>/Library/Application Support/GarageBand/Instrument Library/Sampler/Sampler Files</code> — instrument one-shots</li>
      </ul>
      <p>Drag any of those files straight into the drop zone above. <b>Safari decodes .caf and .aif natively.</b>
      In Chrome, run <code>tools/convert_apple_loops.sh</code> (included with this app) to batch-convert loops to WAV first.</p>`;
